...
import (
	_go "github.com/GinciuuKitakaze/contracts/account/go"
	_go1 "github.com/GinciuuKitakaze/contracts/auth/go"
	_go2 "github.com/GinciuuKitakaze/contracts/pagination/go"
...
type UpdateCurrentUserRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	User          *_go.UpdateUser        `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateCurrentUserRequest) GetUser() *_go.UpdateUser {
	if x != nil {
		return x.User
	}
	return nil
...
const file_gateway_gateway_service_proto_rawDesc = "" +
	"\n" +
	"\x1dgateway/gateway_service.proto\x12\agateway\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1bpagination/pagination.proto\x1a\x1baccount/account_model.proto\x1a\x15auth/auth_model.proto\"P\n" +
	...
	"\x11DeleteCurrentUser\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x18\x82\xd3\xe4\x93\x02\x12*\x10/api/v1/users/meB9Z7github.com/GinciuuKitakaze/contracts/gateway/go;gatewayb\x06proto3"

var (
	file_gateway_gateway_service_proto_rawDescOnce sync.Once
	file_gateway_gateway_service_proto_rawDescData []byte
)

func file_gateway_gateway_service_proto_rawDescGZIP() []byte {
	file_gateway_gateway_service_proto_rawDescOnce.Do(func() {
		file_gateway_gateway_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gateway_gateway_service_proto_rawDesc), len(file_gateway_gateway_service_proto_rawDesc)))
	})
...
var file_gateway_gateway_service_proto_depIdxs = []int32{
	...
	22, // 12: gateway.UpdateCurrentUserRequest.user:type_name -> account.UpdateUser
...
func file_gateway_gateway_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gateway_gateway_service_proto_rawDesc), len(file_gateway_gateway_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   1,
